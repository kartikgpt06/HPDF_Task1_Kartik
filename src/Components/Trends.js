...
const Trends = () => (
  <Paper style={paperStyle}>
    ...
    <div style={styleDiv}><a style={Header} href="#">#India-Israel Meet</a><p style={Subheader}>148k Tweets</p></div>
    ...
    <div style={styleDiv}><a style={Header} href="#">#North-Korea</a><p style={Subheader}>5326 Tweets</p></div>
    <div style={styleDiv}><a style={Header} href="#">#US-Pakistan</a><p style={Subheader}>2466 Tweets</p></div>
    <div style={styleDiv}><a style={Header} href="#">#Padmaavt</a><p style={Subheader}>1357 Tweets</p></div>
  </Paper>
);
